...
/**
 * The SignalStrategy interface represents a strategy for handling different signals with varying
 * algorithms. Implementations of this interface encapsulate the specific algorithm to be executed
 * for each signal.
 */
